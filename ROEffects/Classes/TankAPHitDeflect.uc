...
defaultproperties
{
    ...
    //Level=Take this out
    //Region=Take this out
    //Tag=Take this out
    //Group=Take this out
    //PhysicsVolume=Take this out
    //Location=Take this out
    //Rotation=Take this out
    //DrawScale=0.500000   // not sure about these
   // DrawScale3D=(X=2.000000,Y=2.000000,Z=2.000000) // not sure about these

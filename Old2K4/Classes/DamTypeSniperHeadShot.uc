...
defaultproperties
{
    ...
    DamageOverlayMaterial=none// Material'XGameShaders.PlayerShaders.LightningHit' KFTODO: Maybe replace this
    DamageOverlayTime=0.9

    bAlwaysSevers=true
    bSpecial=true

    WeaponClass=none//class'SniperRifle' KFTODO: Maybe replace this

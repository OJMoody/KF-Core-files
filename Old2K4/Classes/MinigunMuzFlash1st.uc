...
defaultproperties
{
	...
	mGrowthRate=3.00000
	mMeshNodes(0)=none//StaticMesh'MinigunMuzFlash1stMesh'  KFTODO: Maybe replace this mesh
	mSpawnVecB=(Z=0.000000)
	mParticleType=PT_Mesh
	mPosRelative=True
	mRandOrient=false
	mRandTextures=True
	Skins(0)=none//FinalBlend'xGameShaders.WeaponShaders.MinigunMuzFlash1stFinal' KFTODO: Maybe replace this texture
	Style=STY_Additive
}

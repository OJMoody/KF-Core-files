...
defaultproperties
{
    ExplosionDecal=none//class'LinkBoltScorch'
    Speed=1000
    MaxSpeed=1000
    Damage=30
    DamageRadius=150
    ...
    LifeSpan=10.0
    DrawType=DT_Sprite
    Skins(0)=none//Texture'link_muz_green'  KFTODO: Maybe replace this
    Texture=none//Texture'link_muz_green'  KFTODO: Maybe replace this
    ...
    LightSaturation=85
    LightRadius=4
    AmbientSound=none//Sound'WeaponSounds.ShockRifle.ShockRifleProjectile' KFTODO: Maybe replace this
    SoundRadius=60
    SoundVolume=255
    ImpactSound=none //Sound'WeaponSounds.ShockRifle.ShockRifleExplosion' KFTODO: Maybe replace this
}

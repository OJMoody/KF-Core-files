...
{
	TossZ=+0.0
    HitEffectClass=none//class'XEffects.WallSparks' //KFTODO: Maybe Replace this
    DampenFactor=0.5
    DampenFactorParallel=0.8
    ExplosionDecal=class'RocketMark'
    MyDamageType=none//class'DamTypeAssaultGrenade'
    Speed=1000
    MaxSpeed=1500
    Damage=70
    DamageRadius=220.0
    ...
    StaticMesh=none//StaticMesh'WeaponStaticMesh.GrenadeMesh'
    DrawScale=3.0
    AmbientGlow=100
    bBounce=True

...
defaultproperties
{
	...
	Texture=S_Emitter
	Skins(0)=Texture'Effects_Tex.explosions.fire_16frame' // KFTODO: Maybe replace this
	Style=STY_Translucent
	bDynamicLight=false
    AmbientSound=none//Sound'GeneralAmbience.firefx11' // KFTODO: Maybe replace this
    SoundRadius=32
    SoundVolume=190
    SoundPitch=64
}

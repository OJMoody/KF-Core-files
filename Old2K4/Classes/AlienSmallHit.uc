...
defaultproperties
{
	splats(0)=none//Material'xbiosplat'  //KFTODO: Replace this
	splats(1)=none//Material'xbiosplat'  //KFTODO: Replace this
	splats(2)=none//Material'xbiosplat'  //KFTODO: Replace this
    ...
    mNumTileColumns=1
    mNumTileRows=1
    Skins(0)=none//XGameShadersB.Blood.BloodPuffGreen //KFTODO: Replace this
}

...
defaultproperties
{
    ...
    Mesh=none//Mesh'XWeapons_rc.GoopMesh' KFTODO: Replace this
    Skins(0)=none//FinalBlend'GoopFB'
    DrawScale=1.2
    AmbientGlow=80
    bProjTarget=false
    CollisionRadius=2
    ...
    bNetTemporary=false
    ExplodeSound=none//Sound'WeaponSounds.BioRifle.BioRifleGoo1' KFTODO: Replace this
    ImpactSound=none//Sound'WeaponSounds.BioRifle.BioRifleGoo2' KFTODO: Replace this
    bDynamicLight=true
    LightType=LT_Steady

...
defaultproperties
{
	LowGoreBloodEmitClass=none//class'AlienBloodJet'
	BloodEmitClass=class'BloodJet'
	GibSounds(0)=sound'KF_EnemyGlobalSnd.KFNewGib'
    ...
    LowGoreBloodHitClass=none//class'XEffects.AlienSmallHit'
    BloodGibClass=class'Old2k4.BloodExplosion'
    LowGoreBloodGibClass=none//class'XEffects.AlienBloodExplosion'
    NoBloodEmitClass=none//class'BotSparks'
    NoBloodHitClass=none//class'FastBotSparks'
}

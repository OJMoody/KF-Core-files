...
defaultproperties
{
	...
	skins(0)=none//jkrall
	skins(1)=none//jkrall
    AmmunitionClass=none//class'KrallAmmo'
     HitSound(0)=none//injur1k
     HitSound(1)=none//injur2k
     HitSound(2)=none//injur1k
     HitSound(3)=none//injur2k
     //FireSound=Sound'WeaponSounds.ShockRifleAltFire'
     DeathSound(0)=none//death1k
     DeathSound(1)=none//death2k
     DeathSound(2)=none//death1k
     DeathSound(3)=none//death2k
     ChallengeSound(0)=none//chlng1k
     ChallengeSound(1)=none//chlng2k
     ChallengeSound(2)=none//chlng1k
     ChallengeSound(3)=none//chlng2k

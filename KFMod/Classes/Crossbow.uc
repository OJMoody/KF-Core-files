...
defaultproperties
{
    ...
    MagCapacity=1
    Weight=9.000000 // Decreased weight from 10 to 9 in Balance Round 7
    ReloadRate=0.010000
	...
	//** 3d Scope **//
  	scopePortalFOV=12// 2.5x
  	XoffsetScoped = (X=0.0,Y=0.0,Z=0.0)//X=7
  	scopePitch= 0
  	scopeYaw= 0
  	scopePortalFOVHigh=22 // 2.5x
  	ZoomedDisplayFOVHigh=35//30

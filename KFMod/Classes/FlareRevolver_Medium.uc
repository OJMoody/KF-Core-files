...
class FlareRevolver_Medium extends FlameThrowerFlameB;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=120,G=120,R=255))
         ColorScale(2)=(RelativeTime=0.750000,Color=(B=120,G=120,R=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=120,G=120,R=255))
         ...
         SizeScale(0)=(RelativeTime=1.000000,RelativeSize=1.050000)
         StartSizeRange=(X=(Min=5.000000,Max=8.000000),Y=(Min=0.000000,Max=0.000000),Z=(Min=0.000000,Max=0.000000))

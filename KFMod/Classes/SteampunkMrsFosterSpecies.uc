...
//=============================================================================
class SteampunkMrsFosterSpecies extends CivilianSpecies;
...
defaultproperties
{
    ...
    SleeveTexture=Texture'MrsFoster_Steampunk_DLC_1stP.Steampunk_MrsFoster_1stP'
    DetachedArmClass = class'SeveredArmSteampunkMrsFoster'
    DetachedLegClass = class'SeveredLegSteampunkMrsFoster'
}

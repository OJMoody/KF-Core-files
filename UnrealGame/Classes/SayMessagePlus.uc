...
defaultproperties
{
	bBeep=true
	//bComplexString=True
	DrawColor=(R=244,G=237,B=205,A=255)
	RedTeamColor=(R=244,G=237,B=205,A=255)//(R=255,G=64,B=64,A=255)
	BlueTeamColor=(R=244,G=237,B=205,A=255)//(R=64,G=192,B=255,A=255)
	LifeTime=6
}

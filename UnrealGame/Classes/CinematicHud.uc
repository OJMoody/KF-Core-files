...
{
	bHideScope=true
	FontArrayNames(0)="ROFonts.ROBtsrmVr38"//"UT2003Fonts.jFontLarge1024x768"	//37
    FontArrayNames(1)="ROFonts.ROBtsrmVr28"//"UT2003Fonts.jFontLarge800x600"		//29
    FontArrayNames(2)="ROFonts.ROBtsrmVr24"//"UT2003Fonts.jFontLarge"			//24
    FontArrayNames(3)="ROFonts.ROBtsrmVr20"//"UT2003Fonts.jFontMedium1024x768"	//21
    FontArrayNames(4)="ROFonts.ROBtsrmVr18"//"UT2003Fonts.jFontMedium800x600"	//17
    FontArrayNames(5)="ROFonts.ROBtsrmVr14"//"UT2003Fonts.jFontMedium"			//14
    FontArrayNames(6)="ROFonts.ROBtsrmVr12"//"UT2003Fonts.jFontSmall"			//12
    FontArrayNames(7)="ROFonts.ROBtsrmVr9"//"UT2003Fonts.jFontSmallText800x600" //9

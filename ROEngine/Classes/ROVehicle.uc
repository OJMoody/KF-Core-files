...
DefaultProperties
{
    ...
    ImpactDamageSounds(0) = none//Sound'Vehicle_Engines.bottom_out'
    NoEntryTexture=Texture'InterfaceArt_tex.Menu.checkBoxX_b'
    // MergeTODO: Replace this with a proper texture
    ...
    RanOverDamageType=none//class'DamTypeRoadkill'
    CrushedDamageType=none//class'DamTypePancake'
    StolenAnnouncement=Hijacked
    // MergeTODO: Replace these with the real sounds
	StolenSound=none
    RanOverSound=sound'Inf_Player.BodyImpact'
    DestroyedRoadKillDamageType=none//class'DamTypeDestroyedVehicleRoadKill'

	DamagedEffectClass=class'VehicleDamagedEffect'
	DamagedEffectHealthSmokeFactor=0.9
	DamagedEffectHealthMediumSmokeFactor=0.7
	DamagedEffectHealthHeavySmokeFactor=0.4
	DamagedEffectHealthFireFactor=0.20
	DamagedEffectScale=1.0
	DamagedEffectAccScale=0.25
	DamagedEffectFireDamagePerSec=0.75

	SparkEffectClass=class'VehicleImpactSparks'
	...
	ExplosionDamageType=DamTypeVehicleExplosion
	ShakeRotMag=(Z=250)
	ShakeRotRate=(Z=2500)
	ShakeRotTime=6
	ShakeOffsetMag=(Z=10)
	...
	ExplosionSounds(0)=none//sound'Vehicle_Weapons.vehicle_explode01'
	ExplosionSounds(1)=none//sound'Vehicle_Weapons.vehicle_explode02'
	ExplosionSoundVolume=5
	ExplosionSoundRadius=200

	// mergeTODO: replace these with vehicle specific hit sounds
	// Could also use this system for the interior hit sounds
...
//	CrosshairTexture=Texture'ONSInterface-TX.tankBarrelAligned'
	// MergeTODO: Maybe put a proper icon in if we want it
	VehicleHudImage=none
	VehicleHudEngineX=0.5
	VehicleHudEngineY=0.7
...
//    SpawnOverlay(1)=Material'XGameShaders.PlayerShaders.VehicleSpawnShaderBlue'
    ...
    HeadRotationSnapRates=(X=3.0,Y=3.0,Z=3.0)

...
defaultproperties
{
	SideColors(0)=(R=64,G=128,B=128,A=255)
	SideColors(1)=(R=192,G=64,B=64,A=255)
	ObituaryLifeSpan=8.0
	ObjectivesText="OBJECTIVES"


	// Vehicle stuff

	VehicleIconCoords=(X=0,Y=1.0,XL=0,YL=0.2) // Y is modified by YL (after scaling), XL is 0 because actual value is computed from YL
	VehicleIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=255,Y2=255),TextureScale=1.0,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleIconAlt=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=511,Y2=511),TextureScale=2.0,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleEngine=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.22,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=255),Tints[1]=(R=255,G=0,B=0,A=255))
	VehicleThreads(0)=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.tread_left',TextureCoords=(X1=23,Y1=2,X2=37,Y2=125),TextureScale=1.0,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=128),Tints[1]=(R=255,G=0,B=0,A=128))
	VehicleThreads(1)=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.tread_left',TextureCoords=(X1=25,Y1=2,X2=40,Y2=125),TextureScale=1.0,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=128),Tints[1]=(R=255,G=0,B=0,A=128))
	VehicleOccupants=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.RedDot',TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.12,DrawPivot=DP_MiddleMiddle,PosX=0.5,PosY=0.5,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleOccupantsText=(Text="",PosX=0.15,PosY=1.0,WrapWidth=0,WrapHeight=1,OffsetX=8,OffsetY=-4,DrawPivot=DP_LowerLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=false)
	VehicleAmmoTypeText=(Text="",PosX=0.19,PosY=1.0,WrapWidth=0,WrapHeight=1,OffsetX=8,OffsetY=-4,DrawPivot=DP_LowerLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=false)
	VehicleOccupantsTextOffset=0.242

	VehicleAmmoIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.15,PosY=1.0,OffsetX=0,OffsetY=-8,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleAmmoReloadIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.15,PosY=1.0,OffsetX=0,OffsetY=-8,ScaleMode=SM_Up,Scale=0.75,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=128),Tints[1]=(R=255,G=0,B=0,A=128))
	VehicleAmmoAmount=(TextureScale=0.25,MinDigitCount=1,DrawPivot=DP_LowerLeft,PosX=0.15,PosY=1.0,OffsetX=135,OffsetY=-130,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))

	VehicleAltAmmoIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.2,DrawPivot=DP_LowerLeft,PosX=0.25,PosY=1.0,OffsetX=0,OffsetY=-8,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleAltAmmoAmount=(TextureScale=0.2,MinDigitCount=1,DrawPivot=DP_LowerLeft,PosX=0.25,PosY=1.0,OffsetX=135,OffsetY=-40,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleAltAmmoOccupantsTextOffset=-35

	VehicleMGAmmoIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.15,PosY=1.0,OffsetX=0,OffsetY=-8,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	VehicleMGAmmoAmount=(TextureScale=0.25,MinDigitCount=1,DrawPivot=DP_LowerLeft,PosX=0.15,PosY=1.0,OffsetX=145,OffsetY=-60,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	...
	VehicleNormalColor=(R=255,G=255,B=255,A=255)
	VehicleDamagedColor=(R=255,G=222,B=0,A=255)
	VehicleCriticalColor=(R=154,G=0,B=0,A=255)

	VehiclePositionIsPlayerColor=(R=255,G=0,B=0,A=255)
	VehiclePositionIsOccupiedColor=(R=255,G=0,B=0,A=128)
	VehiclePositionIsVacantColor=(R=0,G=0,B=0,A=128)

    VehicleSpeedIndicator=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=255,Y2=255),TextureScale=0.80,DrawPivot=DP_LowerLeft,PosX=1.00,PosY=1.0,OffsetX=0,OffsetY=-4,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    VehicleRPMIndicator=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=255,Y2=255),TextureScale=0.60,DrawPivot=DP_LowerLeft,PosX=1.81,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    VehicleThrottleIndicatorTop=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.throttle_background2',TextureCoords=(X1=0,Y1=0,X2=63,Y2=255),TextureScale=0.6,DrawPivot=DP_LowerMiddle,PosX=2.57,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_Up,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    VehicleThrottleIndicatorBottom=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.throttle_background2_bottom',TextureCoords=(X1=0,Y1=0,X2=63,Y2=255),TextureScale=0.6,DrawPivot=DP_LowerMiddle,PosX=2.57,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_Down,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    VehicleThrottleIndicatorBackground=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.throttle_background',TextureCoords=(X1=0,Y1=0,X2=63,Y2=255),TextureScale=0.6,DrawPivot=DP_LowerMiddle,PosX=2.57,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192))
    VehicleThrottleIndicatorForeground=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.throttle_main',TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.6,DrawPivot=DP_LowerMiddle,PosX=2.57,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    VehicleThrottleIndicatorLever=(WidgetTexture=Texture'InterfaceArt_tex.Tank_Hud.throttle_lever',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.2,DrawPivot=DP_MiddleRight,PosX=2.72,PosY=1.0,OffsetX=0,OffsetY=-7,ScaleMode=SM_None,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    VehicleNeedlesRotationSpeed=30000.0

    VehicleSpeedZeroPosition(0)=-5500
    VehicleSpeedScale(0)=-545
    VehicleRPMZeroPosition(0)=26000
    VehicleRPMScale(0)=-1300

    VehicleSpeedZeroPosition(1)=26000
    VehicleSpeedScale(1)=-430
    VehicleRPMZeroPosition(1)=26000
    VehicleRPMScale(1)=-1300

    VehicleThrottleTopZeroPosition=0.31
    VehicleThrottleTopMaxPosition=0.89
    VehicleThrottleBottomZeroPosition=0.70
    VehicleThrottleBottomMaxPosition=0.88

    VehicleGaugesOccupantsTextOffset=0.4
    VehicleGaugesNoThrottleOccupantsTextOffset=0.36

	// Capture bar
	CaptureBarBackground=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_filled',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarOutline=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_outline',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarAttacker=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_bar',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Right,Scale=0.45,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarDefender=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_bar',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=0.55,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarAttackerRatio=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_bar2',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Right,Scale=0.45,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarDefenderRatio=(WidgetTexture=Texture'InterfaceArt_tex.HUD.capbar_bar2',TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.5,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=0.55,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarIcons[0]=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.23,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=-216,OffsetY=-38,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarIcons[1]=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.23,DrawPivot=DP_LowerMiddle,PosX=0.5,PosY=0.98,OffsetX=216,OffsetY=-38,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CaptureBarTeamColors[0]=(R=0,G=0,B=0,A=255)
	CaptureBarTeamColors[1]=(R=255,G=0,B=0,A=255)
	...
	// VOIP portraits
	PortraitIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.06,DrawPivot=DP_MiddleLeft,PosX=0.0,PosY=0.5,OffsetX=80,OffsetY=0,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	PortraitText(0)=(Text="",PosX=0.0,PosY=0.5,WrapWidth=0,WrapHeight=0,OffsetX=8,OffsetY=0,DrawPivot=DP_LowerLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=true)
	PortraitText(1)=(Text="",PosX=0.0,PosY=0.5,WrapWidth=0,WrapHeight=0,OffsetX=8,OffsetY=0,DrawPivot=DP_UpperLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=true)


	// Location hit materials
	...
	ConsoleMessagePosY=0.8//0.86

//	AssignOKSound=sound'Miscsounds.Menu.Enter'
//	AssignFailedSound=sound'Miscsounds.Menu.Over'
	...
	//ModeText="Mode: "
	//RoamingText="Roaming"
	//FreeChaseText="Free Chase"
	//LockedChaseText="Locked Chase"
	...
	/*SmallFontArrayNames(0)="ROFonts.ROBtsrmVr24"
	SmallFontArrayNames(1)="ROFonts.ROBtsrmVr24"
	SmallFontArrayNames(2)="ROFonts.ROBtsrmVr22"
	SmallFontArrayNames(3)="ROFonts.ROBtsrmVr22"
	SmallFontArrayNames(4)="ROFonts.ROBtsrmVr18"
	SmallFontArrayNames(5)="ROFonts.ROBtsrmVr14"
	SmallFontArrayNames(6)="ROFonts.ROBtsrmVr12"
	SmallFontArrayNames(7)="ROFonts.ROBtsrmVr9"
	SmallFontArrayNames(8)="ROFonts.ROBtsrmVr7"*/
	...
	/*
    FontArrayNames(0)="ROFonts.ROBtsrmVr48"
	FontArrayNames(1)="ROFonts.ROBtsrmVr48"
	FontArrayNames(2)="ROFonts.ROBtsrmVr40"
	FontArrayNames(3)="ROFonts.ROBtsrmVr34"
	FontArrayNames(4)="ROFonts.ROBtsrmVr28"
	FontArrayNames(5)="ROFonts.ROBtsrmVr24"
    ...
    */
    ...
    /*
	FontArrayNames(0)="ROFonts.ROBtsrmVr48"
	FontArrayNames(1)="ROFonts.ROBtsrmVr42"
	FontArrayNames(2)="ROFonts.ROBtsrmVr34"
	FontArrayNames(3)="ROFonts.ROBtsrmVr28"
	FontArrayNames(4)="ROFonts.ROBtsrmVr22"
	FontArrayNames(5)="ROFonts.ROBtsrmVr18"
	FontArrayNames(6)="ROFonts.ROBtsrmVr14"
	FontArrayNames(7)="ROFonts.ROBtsrmVr12"
	FontArrayNames(8)="ROFonts.ROBtsrmVr9"
	*/
	...
	//TODO: REPLACE WITH REAL ICON (justinh)
	ResupplyZoneNormalPlayerIcon=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=192,Y1=192,X2=255,Y2=255),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-200,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=128,B=128,A=128),Tints[1]=(R=255,G=128,B=128,A=128))
	ResupplyZoneNormalVehicleIcon=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=128,Y1=64,X2=191,Y2=127),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-144,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=128,B=128,A=128),Tints[1]=(R=255,G=128,B=128,A=128))
	ResupplyZoneResupplyingPlayerIcon=(WidgetTexture=FinalBlend'InterfaceArt_tex.OverheadMap.overheadmap_icons_fast_flash',TextureCoords=(X1=192,Y1=192,X2=255,Y2=255),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-200,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	ResupplyZoneResupplyingVehicleIcon=(WidgetTexture=FinalBlend'InterfaceArt_tex.OverheadMap.overheadmap_icons_fast_flash',TextureCoords=(X1=128,Y1=64,X2=191,Y2=127),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-144,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))

	MGDeployIcon=(WidgetTexture=Texture'InterfaceArt_tex.HUD.MGDeploy',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-144,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	Digits=(DigitTexture=Material'InterfaceArt_tex.HUD.numbers',TextureCoords[0]=(X1=15,Y1=0,X2=47,Y2=63),TextureCoords[1]=(X1=79,Y1=0,X2=111,Y2=63),TextureCoords[2]=(X1=143,Y1=0,X2=175,Y2=63),TextureCoords[3]=(X1=207,Y1=0,X2=239,Y2=63),TextureCoords[4]=(X1=15,Y1=64,X2=47,Y2=127),TextureCoords[5]=(X1=79,Y1=64,X2=111,Y2=127),TextureCoords[6]=(X1=143,Y1=64,X2=175,Y2=127),TextureCoords[7]=(X1=207,Y1=64,X2=239,Y2=127),TextureCoords[8]=(X1=15,Y1=128,X2=47,Y2=191),TextureCoords[9]=(X1=79,Y1=128,X2=111,Y2=191),TextureCoords[10]=(X1=143,Y1=128,X2=175,Y2=191)))
	StanceIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.25,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=155,OffsetY=-15,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	AmmoIcon=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=240,OffsetY=-7,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	AmmoCount=(TextureScale=0.25,MinDigitCount=1,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=440,OffsetY=-55,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	AutoFireIcon=(WidgetTexture=Texture'InterfaceArt2_tex.HUD.firemode_auto',TextureCoords=(X1=0,Y1=0,X2=127,Y2=31),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=275,OffsetY=-140,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	SemiFireIcon=(WidgetTexture=Texture'InterfaceArt2_tex.HUD.firemode_semi',TextureCoords=(X1=0,Y1=0,X2=127,Y2=31),TextureScale=0.30,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=275,OffsetY=-140,ScaleMode=SM_Right,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CompassBase=(WidgetTexture=Texture'InterfaceArt_tex.HUD.Compass2_main',TextureCoords=(X1=0,Y1=0,X2=255,Y2=255),TextureScale=0.15,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-3,OffsetY=3,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CompassNeedle=(WidgetTexture=TexRotator'InterfaceArt_tex.HUD.TexRotator0',TextureCoords=(X1=0,Y1=0,X2=255,Y2=255),TextureScale=0.155,DrawPivot=DP_MiddleMiddle,PosX=1.0,PosY=1.0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	CompassIcons=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.03,DrawPivot=DP_MiddleMiddle,PosX=1.0,PosY=1.0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WeaponReloadingColor=(R=128,G=128,B=128,A=128)

	HealthFigure=          (WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.3,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=8,OffsetY=-8,ScaleMode=SM_Up,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	HealthFigureBackground=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.3,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=8,OffsetY=-8,ScaleMode=SM_Up,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	HealthFigureStamina=   (WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=127,Y2=255),TextureScale=0.3,DrawPivot=DP_LowerLeft,PosX=0.0,PosY=1.0,OffsetX=8,OffsetY=-8,ScaleMode=SM_Up,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=255),Tints[1]=(R=255,G=0,B=0,A=255))

	WeaponCanRestIcon=(WidgetTexture=Texture'InterfaceArt_tex.HUD.MGDeploy',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-144,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=100,G=100,B=100,A=255),Tints[1]=(R=100,G=100,B=100,A=255))
	WeaponRestingIcon=(WidgetTexture=Texture'InterfaceArt_tex.HUD.MGDeploy',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.45,DrawPivot=DP_LowerRight,PosX=1.0,PosY=1.0,OffsetX=-8,OffsetY=-144,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))

   	MapUpdatedIcon=(WidgetTexture=Material'InterfaceArt_tex.HUD.situation_map_icon',TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.05,DrawPivot=DP_LowerMiddle,PosX=0.85,PosY=1,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
   	MapUpdatedText=(Text="",PosX=0.85,PosY=1.0,WrapWidth=0,WrapHeight=1,OffsetX=0,OffsetY=-80,DrawPivot=DP_LowerMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=false)



	NationHealthFigures(0)=Material'InterfaceArt_tex.HUD.ger_player'
	NationHealthFiguresBackground(0)=Material'InterfaceArt_tex.HUD.ger_player_background'
	NationHealthFiguresStamina(0)=Material'InterfaceArt_tex.HUD.ger_player_Stamina'
	NationHealthFiguresStaminaCritical(0)=FinalBlend'InterfaceArt_tex.HUD.ger_player_Stamina_critical'
	//NationClockBases(0)=Material'ROInterfaceArt.HUD.G_Watch'
	//NationClockHands(0)=Material'ROInterfaceArt.HUD.G_HandRot'

	NationHealthFigures(1)=Material'InterfaceArt_tex.HUD.rus_player'
	NationHealthFiguresBackground(1)=Material'InterfaceArt_tex.HUD.rus_player_background'
	NationHealthFiguresStamina(1)=Material'InterfaceArt_tex.HUD.rus_player_Stamina'
	NationHealthFiguresStaminaCritical(1)=FinalBlend'InterfaceArt_tex.HUD.rus_player_Stamina_critical'
	//NationClockBases(1)=Material'ROInterfaceArt.HUD.R_Watch'
	//NationClockHands(1)=Material'ROInterfaceArt.HUD.R_HandRot'
	StanceStanding=Material'InterfaceArt_tex.HUD.stance_stand'
	StanceCrouch=Material'InterfaceArt_tex.HUD.stance_crouch'
	StanceProne=Material'InterfaceArt_tex.HUD.stance_prone'

	MapBackground=(WidgetTexture=Texture'InterfaceArt_tex.OverheadMap.overheadmap_background',TextureCoords=(X1=0,Y1=0,X2=1023,Y2=1023),TextureScale=1,DrawPivot=DP_UpperLeft,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=128,G=128,B=128,A=255),Tints[1]=(R=128,G=128,B=128,A=255))
	//MapLevelBounds=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.7,DrawPivot=DP_UpperLeft,PosX=0.05,PosY=0.05,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapLegendImageCoords=(X=0.04,Y=0.07,XL=0.555,YL=0.705)
	MapLevelImage=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=511,Y2=511),TextureScale=1,DrawPivot=DP_UpperLeft,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapTexts=(Text="",PosX=0,PosY=0,WrapWidth=0,WrapHeight=0,OffsetX=0,OffsetY=0,DrawPivot=DP_UpperMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=true)
	MapPlayerIcon=(WidgetTexture=FinalBlend'InterfaceArt_tex.OverheadMap.arrowhead_final',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=255),Tints[1]=(R=0,G=0,B=255,A=255))
	MapCoordTextXWidget=(Text="",PosX=0,PosY=-0.022,WrapWidth=0.1,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=128),Tints[1]=(R=255,G=255,B=255,A=128),bDrawShadow=true)
	MapCoordTextYWidget=(Text="",PosX=-0.035,PosY=0,WrapWidth=0.1,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=128),Tints[1]=(R=255,G=255,B=255,A=128),bDrawShadow=true)

	MapIconTeam(0)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=192,Y1=0,X2=255,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconTeam(1)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=128,Y1=0,X2=191,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconDispute(0)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=128,Y1=192,X2=191,Y2=255),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconDispute(1)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=0,Y1=192,X2=63,Y2=255),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconNeutral=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=64,Y1=0,X2=127,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconRadio=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=64,Y1=192,X2=127,Y2=255),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconRally(0)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=64,Y1=128,X2=127,Y2=191),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconRally(1)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=0,Y1=128,X2=63,Y2=191),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconResupply=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=192,Y1=192,X2=255,Y2=255),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconHelpRequest=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=192,Y1=64,X2=255,Y2=127),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconMGResupplyRequest(0)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=192,Y1=128,X2=255,Y2=191),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconMGResupplyRequest(1)=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=128,Y1=128,X2=191,Y2=191),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconAttackDefendRequest=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconArtyStrike=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=0,Y1=64,X2=63,Y2=127),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MapIconDestroyableItem=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=64,Y1=64,X2=127,Y2=127),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=255),Tints[1]=(R=255,G=0,B=0,A=255))
    MapIconDestroyedItem=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=64,Y1=64,X2=127,Y2=127),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=128,G=128,B=128,A=128),Tints[1]=(R=128,G=128,B=128,A=128))
    MapIconVehicleResupply=(WidgetTexture=Material'InterfaceArt_tex.OverheadMap.overheadmap_Icons',TextureCoords=(X1=128,Y1=64,X2=191,Y2=127),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapIconATGun=(WidgetTexture=Material'InterfaceArt2_tex.overheadmaps.overheadmap_IconsB',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.05,DrawPivot=DP_MiddleMiddle,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=0,B=0,A=255),Tints[1]=(R=255,G=0,B=0,A=255))

	MapTimerTitle=(Text="Time Remaining",PosX=0.81,PosY=0.055,WrapWidth=0.0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=true)
	MapTimerTexts[0]=(Text="",PosX=0.748,PosY=0.115,WrapWidth=0.0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)
	MapTimerTexts[1]=(Text="",PosX=0.785,PosY=0.115,WrapWidth=0.0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)
	MapTimerTexts[2]=(Text="",PosX=0.832,PosY=0.115,WrapWidth=0.0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)
	MapTimerTexts[3]=(Text="",PosX=0.870,PosY=0.115,WrapWidth=0.0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleMiddle,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)

	MapLegendCoords=(X=0.015,Y=0.85,XL=0.97,YL=0.11)
	MapLegend=(WidgetTexture=Material'Engine.WhiteSquareTexture',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=1.0,DrawPivot=DP_UpperLeft,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=64),Tints[1]=(R=255,G=255,B=255,A=64))
	MapLegendIcons=(WidgetTexture=none,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.30,DrawPivot=DP_MiddleLeft,PosX=0.05,PosY=0.1,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	MapLegendTitle=(Text="Legend",PosX=0.007,PosY=0.15,WrapWidth=0.9,WrapHeight=0.1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=true)
	MapLegendTexts=(Text="",PosX=0.15,PosY=0.1,WrapWidth=0.8,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)

	MapObjectivesCoords=(X=0.64,Y=0.165,XL=0.345,YL=0.64)
	//MapObjectives=(WidgetTexture=Material'Engine.WhiteSquareTexture',TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=1.0,DrawPivot=DP_UpperLeft,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=64),Tints[1]=(R=255,G=255,B=255,A=64))
	MapObjectivesTitle=(Text="Objectives",PosX=0.025,PosY=0.026,WrapWidth=0.5,WrapHeight=0.1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=true)
    MapRequiredObjectivesTitle=(Text="Required Objectives",PosX=0.025,PosY=0.026,WrapWidth=0.5,WrapHeight=0.1,OffsetX=0,OffsetY=0,DrawPivot=DP_MiddleLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=true)
    MapSecondaryObjectivesTitle=(Text="Secondary Objectives",PosX=0.025,PosY=0.026,WrapWidth=0.9,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_UpperLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=true)
	MapObjectivesTexts=(Text="",PosX=0.05,PosY=0.1,WrapWidth=0.9,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_UpperLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192),bDrawShadow=false)

	//ClockBase=(WidgetTexture=Material'ROInterfaceArt.HUD.G_Watch',TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.25,DrawPivot=DP_MiddleMiddle,PosX=0.25,PosY=0.89,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
	//ClockHand=(WidgetTexture=Material'ROInterfaceArt.HUD.G_Hand',TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.25,DrawPivot=DP_MiddleMiddle,PosX=0.25,PosY=0.89,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))

	MouseInterfaceIcon=(WidgetTexture=Texture'InterfaceArt_tex.Cursors.Pointer',TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=1.0,DrawPivot=DP_UpperLeft,PosX=0,PosY=0,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))

	bAnimateMapIn=false
	bAnimateMapOut=false
	AnimateMapCurrentPosition=1.0
	AnimateMapSpeed=0.3

	bDebugDriverCollision=false
	...
	WhiteFlashTime=0.5
	FadeTime=-1
	MaxMapUpdatedIconDisplayTime=8

	compassStabilizationConstant=2
	compassIconsFadeSpeed=0.15
	compassIconsRefreshSpeed=0.7
	compassIconsPositionRadius=0.8
	//compassIconsUUDistance=256
	/*compassIconsColorsAxis=(R=0,G=0,B=0,A=255)
	compassIconsColorsAllies=(R=64,G=0,B=0,A=255)
	compassIconsColorsNeutral=(R=128,G=128,B=128,A=255)
	compassIconsColorsRally=(R=255,G=255,B=255,A=255)
	compassIconsColorsHelpRequests=(R=0,G=64,B=0,A=255)
	compassIconsColorsMGResupply=(R=0,G=0,B=64,A=255)
	compassIconsRotators(0)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot'
	compassIconsRotators(1)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot2'
	compassIconsRotators(2)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot3'
	compassIconsRotators(3)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot4'
	compassIconsRotators(4)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot5'
	compassIconsRotators(5)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot6'
	compassIconsRotators(6)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot7'
	compassIconsRotators(7)=TexRotator'InterfaceArt_tex.HUD.compass_marker_rot8'*/
	...
	HintFadeTime=0.5
	HintLifetime=12
	//HintDesiredAspectRatio=1.5
	HintDesiredAspectRatio=10
	//HintCoords=(X=0.975,Y=0.4,XL=-1,YL=-0.5)
	HintCoords=(X=0.98,Y=0.03,XL=-1.0,YL=0)
   	HintBackground=(WidgetTexture=Texture'InterfaceArt_tex.Menu.SectionHeader_captionbar',PosX=0,PosY=0.02,TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureScale=0.0,DrawPivot=DP_MiddleMiddle,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192))
   	//HintBackground=(WidgetTexture=Texture'InterfaceArt_tex.Menu.RODisplay',PosX=0,PosY=0.02,TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureScale=0.0,DrawPivot=DP_MiddleMiddle,OffsetX=0,OffsetY=0,ScaleMode=SM_Left,Scale=1.0,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192))
   	HintTitleWidget=(Text="",PosX=0,PosY=0,WrapWidth=0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_UpperLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=true)
   	HintTextWidget=(Text="",PosX=0,PosY=0,WrapWidth=0,WrapHeight=1,OffsetX=0,OffsetY=0,DrawPivot=DP_UpperLeft,RenderStyle=STY_Alpha,Tints[0]=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bDrawShadow=false)

    NetDebugMode=ND_PawnsOnly
}

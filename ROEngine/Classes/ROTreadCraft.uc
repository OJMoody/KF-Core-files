...
defaultproperties
{
     AddedLatFriction = (Points=((InVal=0.0,OutVal=1.0),(InVal=250.0,OutVal=1.0),(InVal=300.0,OutVal=3.0),(InVal=10000000000.0,OutVal=3.00)))

 	// Onslaught stuff we use
 	// MergeTODO: Replace with proper damage types
	...
	// Effects
	 TrackDamagedSound=none//sound'Vehicle_Engines.track_broken'
     ...
     DisintegrationHealth=-10000.000000 // -10000 default to make classes enable disintegration.
	...
	// Positioning
     ...
     DrivePos=(X=30.000000,Y=-20.00,Z=55.000000)

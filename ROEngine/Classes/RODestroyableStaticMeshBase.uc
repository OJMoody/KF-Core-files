...
defaultproperties
{
	DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'DebugObjects.debugarrow1'//StaticMesh'WeaponPickupSM.Ammo.Warhead3rd' // Replace this with something cool
    ...
    OnDestroyCriticalMessage=""
    OnDestroyBroadcastTarget=CMBT_Nobody
}

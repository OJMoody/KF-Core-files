...
defaultproperties
{
	// Took this out because it caused replication issues.
	//bHidden = true			// start initially hidden so they aren't floating about the map
	...
	bNetTemporary=true//false change back when I figure out what is wrong
	Physics=PHYS_Projectile
	DrawType=DT_StaticMesh
	DrawScale=0.001// Make it small and really hard to see for now, til we fix the hovering shell problem
	//DrawScale=5.0
	...
	AmbientGlow=100
	//AmbientSound=Sound'ROArtillery.Shell_Amb'
	SoundRadius=100
	SoundVolume=255
...
//	CloseSound(3)=sound'Artillery.zoomin.zoom_in03'
	...
	Damage=500
	DamageRadius=1000
	CullDistance=50000// About 1000 meters

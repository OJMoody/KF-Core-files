...
defaultproperties
{
	...
	FFKillLimit=3
	FFArtyScale=1.0
	FFExplosivesScale=5.0
	FFPunishment=FFP_Kick
	MaxTeamDifference=2
	MaxPlayersOverride=0
	bForgiveFFKillsEnabled=true
    bShowServerIPOnScoreboard=false
    bShowTimeOnScoreboard=false
	DeathMessageMode=DM_All
	DeathMessageClass=class'RODeathMessage'
	GameMessageClass=class'ROGameMessage'
...
//		case "bPlayersMustBeReady":			return default.PropDescText[22];
	...
	//PropsDisplayText(6)="World Stats Logging"
	...
	DefaultEnemyRosterClass="ROEngine.ROTeamRoster"//"xGame.xTeamRoster"
    ...
    //AccessControlClass="ROGame.ROAccessControl" - Deprecated Retail Version
    Acronym="RO"
    MapPrefix="RO"
    BeaconName="RO"
	...
	AlternateSpawns(0)=(X=0,Y=76.0,Z=8.0)
	AlternateSpawns(1)=(X=-52.0,Y=64.0,Z=8.0)
	AlternateSpawns(2)=(X=-84.0,Y=4.0,Z=16.0)
	AlternateSpawns(3)=(X=-60.0,Y=-56.0,Z=12.0)
	AlternateSpawns(4)=(X=20.0,Y=-72.0,Z=12.0)
	AlternateSpawns(5)=(X=80.0,Y=-48.0,Z=12.0)
	AlternateSpawns(6)=(X=80.0,Y=8.0,Z=12.0)
	AlternateSpawns(7)=(X=76.0,Y=60.0,Z=8.0)
	AlternateSpawns(8)=(X=-0.0,Y=0.0,Z=128.0)

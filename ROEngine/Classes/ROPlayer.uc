...
defaultproperties
{
	...
	bFirstObjectiveScreenDisplayed=false
	bShowMapOnFirstSpawn=true

	//ROMidGameMenuClass="ROInterface.ROMidGameMenu"
	ROMidGameMenuClass="ROInterface.ROGUIRoleSelection"
	// Comment out for dev builds
	//LoginMenuClass="ROInterface.ROGUITeamSelection"

	// VOIP variables
	AutoJoinMask = 7 // Autojoin Team and Local by default		// Bit masked 1 - Public, 2 - Local, 4 - Team
    ...
    VehicleCheckRadius=350.0//700.0
    ...
    bDisplayedRoleSelectAtLeastOnce=false
    FadeFromBlackFadeSpeed=0.15

    bShowHints=true

    // Vehicledriving
    ThrottleChangeRate=2200//1750.0
    bInterpolatedTankThrottle=true
    bInterpolatedVehicleThrottle=false
    bManualTankShellReloading=false

    // Music settings
    bDisableMusicInGame=false

    // Jarring settings
    JarrMoveMag=40.0
    JarrMoveRate=200.0
    JarrMoveDuration=3.0
    JarrRotateMag=2000.0
    JarrRotateRate=10000.0
    JarrRotateDuration=4.0

    // Kill Info
    LastFFKiller=none
    LastFFKillAmount=0.0
}

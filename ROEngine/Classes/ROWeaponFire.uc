...
/*	MuzzleBone=Muzzle
	...
	ShellIronSightOffset=(X=30,Y=0,Z=0)
    ...
    PctProneIronRecoil = 0.45   // this is the percentage of recoil felt compared to standard prone
    PctBipodDeployRecoil = 0.15	// this is the percentage of recoil felt compared to firing from the hip

...
defaultproperties
{
	...
	//bSkipActorPropertyReplication=true // Commented out, I think it was messing up the overheads - Ramm 07/22/04
	//bReplicateMovement=false // Ditto aboove
	bOnlyDirtyReplication=true
	//bObjInitiallyActive=true
	bInitiallyActive=true
	// We want to be able to get tick and timer calls in our objectives
	bStatic=false
	bNoDelete=true

	// UT2k4 setting. We need it so the bActive variable will get replicated
	bReplicateObjective=true
	Texture=Texture'InterfaceArt_tex.OverheadMap.ROObjectiveIcon'
	LabelCoords=(X1=-10000,X2=-10000,Y1=-10000,Y2=-10000)
}

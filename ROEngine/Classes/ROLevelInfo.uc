...
defaultproperties
{
	...
	//Begin Object Class=ROGEPlatoonCommanderH name=Role1
	//	Limit=0
	//End Object

	//Begin Object Class=ROSUPlatoonCommanderM35RKKA name=Role2
	//	Limit=0
	//End Object
    TempFahrenheit = 65
	Axis=(Nation=NATION_Germany,UnitName="Axis",SpawnLimit=150,ReinforcementInterval=30,ArtilleryStrikeLimit=3,ArtilleryStrikePattern=STR_Normal,ArtilleryBatterySize=BAT_4_to_6,ArtillerySalvoAmount=SALVO_4_to_6,ArtilleryStrikeInterval=INT_Short_30s,ArtilleryStrikeDelay=DELAY_Short_15s)
	Allies=(Nation=NATION_SovietUnion,UnitName="Allies",SpawnLimit=150,ReinforcementInterval=30,ArtilleryStrikeLimit=3,ArtilleryStrikePattern=STR_Normal,ArtilleryBatterySize=BAT_4_to_6,ArtillerySalvoAmount=SALVO_4_to_6,ArtilleryStrikeInterval=INT_Short_30s,ArtilleryStrikeDelay=DELAY_Short_15s)
	bDirectional = true
	bDebugOverhead=false
	RallyPointInterval=5;

	AxisSatchelsPerSapper=1;	// Number of satchels an axis sapper starts with
	AlliedSatchelsPerSapper=1;	// Number of satchels an allied sapper starts with
    ...
    VehicleBotRoleBalance=0.7

	// SET TO FALSE FOR RELEASE!!!! - Ant
	bRODebugMode = false
}

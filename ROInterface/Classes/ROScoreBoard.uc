...
defaultproperties
{
	...
	TeamNameAxis="Axis"
	NameLength=0.30
	TeamScoreLength=0.10
	RoleLength=0.20
	ScoreLength=0.10
	TimeLength=0.10
	PingLength=0.10
	TeamColors(0)=(R=64,G=128,B=128,A=255)
	TeamColors(1)=(R=192,G=64,B=64,A=255)
	TeamColors(2)=(R=32,G=32,B=32,A=255)
	TeamColors(3)=(R=128,G=128,B=128,A=255)
	HighlightColor=(R=128,G=128,B=128,A=64)

...
defaultproperties
{
	...
	DetachedArmClass=class'SeveredArmPatriarch_CIRCUS'
	DetachedLegClass=class'SeveredLegPatriarch_CIRCUS'
	DetachedHeadClass=class'SeveredHeadPatriarch_CIRCUS'

	HitSound(0)=Sound'KF_EnemiesFinalSnd_CIRCUS.Kev_Pain'
	AmbientSound=Sound'KF_EnemiesFinalSnd_CIRCUS.Idle.Kev_IdleLoop'

	MoanVoice=Sound'KF_EnemiesFinalSnd_CIRCUS.Kev_Talk'
	DeathSound(0)=Sound'KF_EnemiesFinalSnd_CIRCUS.Kev_Death'
	JumpSound=Sound'KF_EnemiesFinalSnd_CIRCUS.Kev_Jump'

	MeleeAttackHitSound=sound'KF_EnemiesFinalSnd_CIRCUS.Kev_HitPlayer_Fist'
	MeleeImpaleHitSound=sound'KF_EnemiesFinalSnd_CIRCUS.Kev_HitPlayer_Impale'
	RocketFireSound=sound'KF_EnemiesFinalSnd_CIRCUS.Kev_FireRocket'
